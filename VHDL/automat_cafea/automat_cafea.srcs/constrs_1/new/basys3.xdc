...
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports milkvalve]
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports watervalve]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports grinder]
